...
namespace AvtoMigBussines.CarWash.Services.Interfaces
{
    public interface IWashOrderService
    {
        ...
        Task<IEnumerable<WashOrder>> GettAllCompletedWashOrdersFilterAsync(string? aspNetUserId, int? organizationId, DateTime? dateOfStart, DateTime? dateOfEnd);
        ...
        Task<bool> ReadyUpdateWashOrderAsync(WashOrder washOrder);
    }
}
